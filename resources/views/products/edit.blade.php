            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-2">
                        ...
                        <li class="breadcrumb-item active small" aria-current="page">Modify Product</li>
                    </ol>
                </nav>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-12">
                            ...
                            <input type="text" name="name" class="form-control-refined w-100 @error('name') is-invalid @enderror" value="{{ old('name', $product->name) }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group-refined">
                                ...
                                <input type="number" step="0.01" name="price" class="form-control w-100" value="{{ old('price', $product->price) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group-refined">
                                ...
                                <input type="text" name="sku" class="form-control w-100" value="{{ old('sku', $product->sku) }}">
                            </div>
                        </div>
                        <div class="col-12">
                            <label class="form-label-refined">Detailed Description</label>
                            <textarea name="description" class="form-control-refined w-100" rows="4">{{ old('description', $product->description) }}</textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label-refined">Inventory Status</label>
                            <select name="status" class="form-control-refined w-100">
                                <option value="active" {{ old('status', $product->status) == 'active' ? 'selected' : '' }}>Active / In Stock</option>
                                <option value="inactive" {{ old('status', $product->status) == 'inactive' ? 'selected' : '' }}>Inactive / Out of Stock</option>
                            </select>
                        </div>
                    </div>

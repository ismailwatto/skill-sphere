            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-2">
                        ...
                        <li class="breadcrumb-item active small" aria-current="page">Update Account</li>
                    </ol>
                </nav>
                <h3 class="fw-bold mb-0">Modify Account</h3>
            </div>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-6">
                            ...
                            <select name="role_id" class="form-control-refined w-100 @error('role_id') is-invalid @enderror" {{ Auth::id() === $user->id ? 'disabled' : '' }}>
                            ...
                            @if(Auth::id() === $user->id)
                                ...
                                <div class="extra-small text-info mt-2"><i class="bi bi-info-circle me-1"></i> Self-role modification is disabled.</div>
                            @endif
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-control-refined w-100" {{ Auth::id() === $user->id ? 'disabled' : '' }}>
                            ...
                            @if(Auth::id() === $user->id)
                                ...
                                <div class="extra-small text-info mt-2"><i class="bi bi-info-circle me-1"></i> Self-status modification is disabled.</div>
                            @endif
                        </div>
                        
                        <div class="col-12 mt-4">
                            <div class="alert bg-light border-0 small text-muted rounded-3">
                                <i class="bi bi-shield-lock me-2"></i> Leave password fields blank to keep the current password.
                            </div>
                        </div>
